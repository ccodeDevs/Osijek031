package com.ccode.osijek031.news.managers;
...
import com.ccode.osijek031.volley.SimpleXmlRequest;
...
public class NewsDataManager {
	...
	public void getNews(final OnNewsLoadedListener downloadListener,
		...
		SimpleXmlRequest<NewsWrapper> request = new SimpleXmlRequest<NewsWrapper>(
				Method.GET, url, NewsWrapper.class, null,
