...
import com.ccode.osijek031.volley.GsonUtils.GsonTypeAdapter;
...
public class GsonRequest<T> extends Request<T> {
	...
	public GsonRequest(String url, Class<T> clazz, String jsonRequestBody,
		...
		this(jsonRequestBody == null ? Method.GET : Method.POST, url, clazz,
				jsonRequestBody, listener, errorListener);
	}

	public GsonRequest(int method, String url, Class<T> clazz,
			String jsonRequestBody, Listener<T> listener,
		...
		this.gson = GsonUtils.createGsonInstance(EnumSet
				.of(GsonTypeAdapter.DATE));
	}
