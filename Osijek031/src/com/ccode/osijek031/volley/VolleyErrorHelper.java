...
public class VolleyErrorHelper {
	...
	public static void handleErrorWithToast(Object error, Context context) {
		if (context != null) {
			Toast.makeText(context, getMessage(error, context),
					Toast.LENGTH_SHORT).show();
		}
	}

	public static void handleErrorWithTextView(Object error, Context context,
			TextView textView) {
		if (context != null) {
	...
	public static String getMessage(Object error, Context context) {
		...
		try {
			is401 = ((NoConnectionError) error).getMessage().contains(
					"authentication");
		} catch (Exception e) {
		}
		if (context != null) {
