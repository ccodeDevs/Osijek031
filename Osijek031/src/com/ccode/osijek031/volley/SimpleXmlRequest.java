...
import com.ccode.osijek031.utils.Utils;
...
public class SimpleXmlRequest<T> extends Request<T> {
	...
	private static final String PROTOCOL_CONTENT_TYPE = String.format(
			"text/plain; charset=%s", PROTOCOL_CHARSET);
	...
	public SimpleXmlRequest(String url, Class<T> clazz,
		...
		this(requestBody == null ? Method.GET : Method.POST, url, clazz,
				headers, (requestBody == null) ? null : requestBody.toString(),
	...
	protected Response<T> parseNetworkResponse(NetworkResponse response) {
		try {
			...
			return Response.success(result,
					VolleyHttpHeaderParser.parseCacheHeaders(response));
		} catch (Exception e) {
